app
  ...
  .controller("user-ctrl", function ($scope, $rootScope, $http, $compile) {
    ...
    $scope.edit = function (item) {
      $rootScope.form = angular.copy(item);
      //   $("#edit").modal("show");
    };
    ...
    $scope.update = function () {
      var item = angular.copy($scope.form);
      $http
        .put(`${url}/${item.username}`, item)
        .then((resp) => {
          var index = $scope.items.findIndex(
            (p) => p.username == item.username
          );
