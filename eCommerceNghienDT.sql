...
INSERT Users (id, username, password, phone, fullname, birthday, email, address, image, created_at, updated_at, token) VALUES (5, N'negentan4', N'mazQIIQ', N'7763459232', N'Nickola Egentan', CAST(N'2008-09-10' AS Date), N'negentan4@mysql.com', N'447 Trailsway Center', N'avt.png', CAST(N'2021-12-10T02:00:00.000' AS DateTime), CAST(N'2022-03-27T00:00:00.000' AS DateTime), NULL)
...
INSERT Users (id, username, password, phone, fullname, birthday, email, address, image, created_at, updated_at, token) VALUES (9, N'gdambrogio8', N'mZZ7kYNGUi', N'4442416947', N'Galvan D''Ambrogio', CAST(N'1943-12-17' AS Date), N'gdambrogio8@bloomberg.com', N'9 Morrow Terrace', N'avt.png', CAST(N'2022-08-23T00:00:00.000' AS DateTime), CAST(N'2022-01-05T00:00:00.000' AS DateTime), NULL)
...
INSERT Users (id, username, password, phone, fullname, birthday, email, address, image, created_at, updated_at, token) VALUES (13, N'otookerc', N'vM6pWJ', N'5259497277', N'Olivier Tooker', CAST(N'1908-05-29' AS Date), N'otookerc@prnewswire.com', N'68 Twin Pines Avenue', N'avt.png', CAST(N'2021-12-13T00:00:00.000' AS DateTime), CAST(N'2022-09-19T00:00:00.000' AS DateTime), NULL)
INSERT Users (id, username, password, phone, fullname, birthday, email, address, image, created_at, updated_at, token) VALUES (14, N'abartrapd', N'jrv1xHfxxc', N'1608956479', N'Alma Bartrap', CAST(N'1915-06-01' AS Date), N'abartrapd@blogger.com', N'05781 Springview Street', N'avt.png', CAST(N'2022-04-02T00:00:00.000' AS DateTime), CAST(N'2022-02-11T00:00:00.000' AS DateTime), NULL)
...
INSERT Users (id, username, password, phone, fullname, birthday, email, address, image, created_at, updated_at, token) VALUES (18, N'dsoppith', N'wQcjyzM', N'6362316037', N'Derrick Soppit', CAST(N'1998-10-07' AS Date), N'dsoppith@washingtonpost.com', N'83 Manley Crossing', N'avt.png', CAST(N'2022-05-26T00:00:00.000' AS DateTime), CAST(N'2022-05-21T00:00:00.000' AS DateTime), NULL)
...
INSERT Orders (id, status, created_at, updated_at, user_id) VALUES (1, 1, CAST(N'2022-10-26T18:17:22.000' AS DateTime), CAST(N'2022-12-23T07:25:23.000' AS DateTime), 1)
SET IDENTITY_INSERT Orders OFF
GO

SET IDENTITY_INSERT OrderDetails ON 
INSERT OrderDetails (id, price, quantity, order_id, product_id) VALUES (1, 3000000, 3, 1, 1)
SET IDENTITY_INSERT OrderDetails OFF
GO

SET IDENTITY_INSERT Reviews ON 
INSERT Reviews (id, content, mark, image, created_at, orderdetail_id) VALUES (1, N'Hàng sài rất ok', 10, N'anh1.png', CAST(N'2022-10-26T18:15:22.000' AS DateTime), 1)
